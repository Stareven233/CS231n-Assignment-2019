...
class KNearestNeighbor(object):
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            # 此时利用广播用X[i]这一行去减X_train整个矩阵，然后逐元素平方后按行相加
            # 最后开方后仍是一个行向量，赋给dists的第i行即可完成一个测试样例对所有训练集的计算
    ...
    def compute_distances_no_loops(self, X):
        ...
        # pass
        # dists = np.sqrt(np.matmul(-X, self.X_train.T) ** 2)
        ...
        # 稍微有点理解，把L2中的差平方(a-b)**2换成了(a**2 + b**2 - 2*a*b)?
